...
A1. Initially I picked address, first and last name because I knew that both data sets contained those. As a class though we went through and confirmed  these and also added residential city as well.
...
A2. From people who have registered this year there's been 326 donations, 77 donations since July 20. Brandyn Best gave 4 donations, the most donations since July 20.
...
A3. The breakdown of the party and gender of the donors are below in the table. Harris received 32 donations from non-Democrats.
...
A4: What is the total dollar amount of donations received from each political party, broken down by gender?

```{r}
harris_combined_and_new_voters |>
  group_by(Party, Gender) |>
  summarise(total_donations = sum(amount, na.rm = TRUE)) |>
  arrange(Party, desc(total_donations))
```