...
**A1: Grassroots Media and Break Something Inc both had the largest amount of spending under advertising, specifically media and online advertising.**
...
**A2: Both campaigns focus on spedning their money in advertisements. One focuses on a more traditional method, the grassroot method while the other one focuses on. Break Something takes a more "intense approach" and use different advertising techniques.**
...
# Filter for Payroll/Salary spending
payroll_spending <- clean_md_senate_expenses %>%
  filter(purpose_clean) %>%
