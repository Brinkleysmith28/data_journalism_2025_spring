...
* **Analysis summary**: I was able to confirm my findings after filtering for donations made by Mark R. Craig between May 16th and June 29th. I was able to see that Craig made a single donation of $5,200 to Berger's committee and contributed a total of $33,200 during the session which aligned with what was reported in the article. 
...
#the code above proves the maximum $200 donations to Berger 
...
#the code above proves his donations were all during the six week legislative session
...
#the code above proves that MARK R CRAIG has put more then $30,000 into the NC General Assembly session
```
...
* **Analysis summary**: We were able to prove the first part of the sentence that there was $3.4 million given in the in-session giving. Could not prove at this point in time because we couldn't find Cooper's campaign account information in our data. It was supposed to be named 'Roy Cooper For North Carolina' but we came up short. After trying numerous combinations and other possible clean_name entries, still nothing so we were unable to prove this part.
...
donors |>
  filter(date >= '2018-05-16' & date <= '2018-06-29') |>
  summarise(sum(amount))
#the above code shows the in-session giving, the $3.4 million.
...
* **Analysis summary**: We weren't able to confirm the results of this finding on account of the article itself was not as detailed enough. We were only able to deduce the PAC's that had lobbyist who donated during the session because we had to do extensive research in order to narrow it down. I had to go and search each PAC individually and go back to 2018 and find out who had lobbyists using government websites. Still, we had a difficult time trying to figure out which out of the ones we found donated 16,000 dollars with check "written before session."

```{r}
##used chat to help improve code structure, I had the code already written but chat added the part about for total PAC donations##
...
# View total amount; filtered these specific PAC's because they were listed, by way of a NC Secretary of State's Office 2018 document, as North Carolina lobbyist listings. also took into account information I found that listed PAC's with lobbyists at this time in this assembly and pulled out the specific ones listed in our data set and time frame etc.#
...
Below is the detailed memo:

What are the main findings of the story?
This WRAL article is centered around the exploration of how CEOs and other types of top executives were found to have largely contributed to campaign accounts during session. It’s against state law to donate during session, but groups have found workarounds. Either business executives donate as individuals, or PACs write checks before session and send them during session. The story is pointing out these loopholes they found in campaign donation rules and how they were exploited. They named specific groups and individuals who they found donated during session, including groups like hog farmers and beer distributors that had significant legislative stakes in that 2018 session. They did this reporting by analyzing campaign finance reports for legislators, then talking to people who donated or received donations, and to a watchdog group. It’s an example of data journalism informing investigative journalism to expose something that could be really impactful.
