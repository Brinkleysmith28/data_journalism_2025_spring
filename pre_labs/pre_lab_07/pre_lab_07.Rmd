...
```{r echo=FALSE}
census_api_key("725ab0e0f0a2f0fedfbc3490050e3a6ed61ca741", install=TRUE, overwrite = TRUE)
```
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer: Howard County, Maryland with a median household income of $140,971.**
...
Is the difference between Calvert and Montgomery significant? **Answer: No, the difference is not statistically significant.**

Is the difference between Howard and everyone else significant? **Answer: Yes, the difference is statistically significant.**
...
**Answer: None of the 20 zip codes with the largest amounts have an estimated median household income of less than $50,000.**
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **Answer: What are some of the job industries that are contributing to high median household incomes in these areas? **
